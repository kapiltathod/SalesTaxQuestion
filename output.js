...
function processData(allText) {
  ...
  for (let i = 1; i < inputArray.length; i++) {
	...
	for (let i = 0; i < itemLists.length; i++) {
		...
		//let ProductName = productName[i].spilt(",");
   	//console.log(ProductName);
		...
		//console.log(itemLists);
		//console.log(productName);
    //if (productName.includes(exempt."book") || productName.includes(exempt."chocolate")) {
    	//console.log("yes");
    //}

    //if (productName.includes("exempt[0]") || productName.includes("exempt[1]") || productName.includes("exempt[]") ) {
    	//console.log("yu");
   // }


    //}
    //let ProductNamearr = productName.split(" ");
   /// console.ProductNamearr;
   ...
   // }
		...
		if (productName.includes("chocolate")) {
			...
			}	else if (productName.includes("music")) {
				//tax1 = price * 0.1;
				price = price + price * 0.1;
				factor = 0.05;
				price = Math.ceil(price/factor) * factor;
